...
exports.index = function (req, res) {
    ...
    pool
        .query(function () {
            return { 
                query: "INSERT INTO `categories` (`category_name`, `category_desc`,`url`, seo_title, seo_description, seo_keyword, logo_category, card_category, other_category) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
                params: [req.body.category_name, req.body.category_desc, req.body.url || null, req.body.seo_title, req.body.seo_description, req.body.seo_keyword, req.body.logo_category, req.body.card_category, req.body.other_category]
            };
        })
        .success(function (categoryRows) {
                                ...
                                pool
                                    .query(function () {
                                        return {
                                            ...
                                            params: [categoryRows.insertId, keywordId]
                                        };
                                    })
                                    .success(function (rows) {
                                        if (rows.length > 0){
                                        ...
                                        if (i < keywords.length) {
                                            ...
                                            res.send({status: 200, insertId: categoryRows.insertId});
                                        }
                                    })
                            });
                        })
