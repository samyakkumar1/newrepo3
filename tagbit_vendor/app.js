            ...
            template(template_name, template_options, function(err, html, text) {
                if (err) {
                    ...
                    var mailOptions = extend({}, {
                        ...
                        html: html,
                        text: text,  
                        bcc: global.config.emailConfig.auth.user,
...
app.use(app.router);
app.get('/', pages.index);
app.get('/logo/listLogos', pages.listLogo);
app.get('/logo/logoParams', pages.logoParams);
app.get('/logo/purchasedLogos', pages.purchasedLogos);
app.get('/card/listCards', pages.listCard);
app.get('/card/cardParams', pages.cardParams);
app.get('/category/listCategories', pages.listCategory);
app.get('/admin/viewCardOrders', pages.viewCardOrders);
app.get('/admin/viewOtherOrders', pages.viewOtherOrders);
app.get('/admin/pricingAdmin', pages.pricingAdmin);
app.get('/admin/shippingAdmin', pages.shippingAdmin);
app.get('/admin/transactions', pages.transactions);
app.get('/admin/reports', pages.reports);
app.get('/admin/new-reports', pages.new_reports);
app.get('/admin/invoice', pages.invoice);
app.get('/other-products/list', pages.otherProducts);
app.get("/other-products/add", pages.addOtherProducts);
app.get('/users', pages.users);
app.get('/emailer', pages.emailer);
app.get('/composer', pages.composer);
...
function readSettingsFile() {
    ...
    /*
    settingsFile.emailConfig.auth.pass = decrypt(settingsFile.emailConfig.auth.pass);
    global.transporter = nodemailer.createTransport(settingsFile.emailConfig);
    */
