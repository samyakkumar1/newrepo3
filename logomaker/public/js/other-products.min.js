                    ...
                    if (c.hasOwnProperty(i)) {
                        ...
                        for (var j = $("#page" + i), d = 0; d < c[i].items.length; d++) {
                            ...
                            m.indexOf(k.control_type) > -1 ? doGetWithExtraParams("/getOtherProductSettingsValues", {
                                ...
                                200 == a.status ? (q(b.setting_id, b.controlType, b.elem, a, b.settingName, b.relatedSetting, b.independent_pricing), h()) : (console.log(a), showToast("Error: " + a.msg))
                            }, function (a) {
                                console.log(a),
                ...
                if (G) 
                    ...
                    var c = function (a) {
                        if (a) {
                            ...
                            var d = $('<li class="col-md-3"><span class="custom-logo"><img src="/img/upload_arrow.png"><br />Upload custom logo</span></li>');
                            $(".logos-list").append(d),
                            d.click(function () {
                    ...
                    $("body,html").animate({
                        ...
                        e("one");
                        var a = "No Logos found! <a href='/logo-design-online'><b>Click here</b></a> to create one. or <a class='link' id='uploadCustomLogo'><b>Click here</b></a> to upload one.";
                        if (1 == isLoggedIn()) 
                                    ...
                                    window.editorFrame.setParent ? (window.editorFrame.setParent({
                                        ...
                                        repaint: function () {
                                            doGet("/getOtherProductDetails?id=" + otherProductId, {}, function (a) {
                                                200 == a.status ? (frontParams = a.details.front_logo_params.split(";"), backParams = a.details.back_logo_params.split(";"), frontBaseParams = a.details.base_params_front.split(";"), backBaseParams = a.details.base_params_back.split(";"), c()) : (console.log(a), bootbox.alert("Error: " + a.msg))
                                            }, function (a) {
                                                console.log(a),
                                                bootbox.alert("Communication Error!!")
                                            })
