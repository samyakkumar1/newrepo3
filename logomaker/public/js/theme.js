			...
			build: function() {
				...
				self.stickyMenuActivate = function() {
					...
					if($('.create-logo').length>0)
					{
						$(window).scroll(function(){
							if($(this).scrollTop()>1){
								$('.top-page-header').addClass('sticky-logoactive');
							}
							else{
								$('.top-page-header').removeClass('sticky-logoactive');
							}
						});
						/*
						}*/
